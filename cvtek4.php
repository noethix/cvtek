...
print("Âge: ");
print $informations["Age"]= age ($DOB) .PHP_EOL;
print("Adresse: ");
...
/*foreach($candidats as $key => $informations) 
{
    $key["LastName"] = readline("And now type: "), $key["LastName"];
}
*/
goto a;
